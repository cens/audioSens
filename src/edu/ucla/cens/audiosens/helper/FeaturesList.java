...
{	
	...
	public static final String SPEECHINFERENCEFEATURES = "SpeechInferenceFeatures";
	public static final String NUMCORPEAKS = "NoOfCorrelationPeaks";
	public static final String MAXCORPEAK = "MaxCorrelationPeakValue";
